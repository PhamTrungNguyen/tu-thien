...
const DeletePostByIdService = async (query) => {
    ...
    // console.log("🚀 ~ file: postService.js ~ line 45 ~ DeletePostByIdService ~ post", post)

    Post.destroy({
        where: {
            id: idPost //this will be your id that you want to delete
        }
    }).then(function (rowDeleted) { // rowDeleted will return number of rows deleted
        console.log("🚀 ~ file: postService.js ~ line 52 ~ DeletePostByIdService ~ rowDeleted", rowDeleted)
        if (rowDeleted === 1) {
