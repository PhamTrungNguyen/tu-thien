...
const postMoneyService = async (query) => {
    ...
    // }
    const array = [...post.myColData, userId]
    console.log("🚀 ~ file: postService.js ~ line 47 ~ postMoneyService ~ myColData", post.myColData)
    // Post.update({ myColData: post.dataValues.myColData.push(userId) }, { where: { id: idPost } })
