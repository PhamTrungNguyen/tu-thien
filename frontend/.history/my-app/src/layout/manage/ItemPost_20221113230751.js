...
const ItemPost = ({ props, index }) => {
    ...
    console.log("🚀 ~ file: ItemPost.js ~ line 12 ~ ItemPost ~ idPost", idPost)
    console.log("🚀 ~ file: ItemPost.js ~ line 11 ~ ItemPost ~ message", message)
    ...
    const handleDeletePost = () => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                handleDeleteAccountByID(`http://localhost:8080/api/post/DeletePostById?idPost=${idPost}`)
                Swal.fire(
                    'Xóa thành công!',
