            ...
            <form onSubmit={handleSubmit(handleAddPost)}
                ...
                <div className="text-center ml-[200px]">
                    <button
                        // disabled={!isValid}
                        type="submit"
                        className="cursor-pointer font-medium p-[10px] border-[2px] border-transparent bg-[#e22d28]  text-white hover:bg-white hover:text-[#e22d28] hover:border-[#e22d28] duration-300 text-[15px] text-center rounded-[10px]  w-[200px]"
                    >
                        Thêm
                    </button>
                </div>
