						...
						<div className="upload__image-wrapper ">
							...
							<div className="flex gap-x-[20px] pt-[30px] items-center justify-center">
								<div
									...
									{...dragProps}
									className="cursor-pointer font-medium p-[10px] border bg-[#e22d28]  text-white hover:bg-white hover:text-[#e22d28] hover:border-[#e22d28] duration-300  text-center rounded-[10px]"
								>
									Tải hình ảnh lên
								</div>
								<div
