                    ...
                    <div className="admin-profile hide">
                        ...
                        <div className="admin-info">
                            <h3 className="cursor-pointer">
                                <a href="/signpage"> {` ${<props></props>?.displayName
                                    ? <props></props>?.displayName
                                    : <props></props>?.username || "Vui lòng đăng nhập"
                                    }  `}{" "}</a>
                            </h3>
                            {<props></props>?.roleId === 1 && <h5>Người dùng</h5>}
                            {<props></props>?.roleId === 2 && <h5>Quản lý</h5>}
                            {<props></props>?.roleId === 3 && <h5>Admin</h5>}
                        </div>
                    </div>
                    <button
                        className="log-out"
...
{` ${props.displayName === "undefined" ? props.displayName : props.username || "Vui lòng đăng nhập"
                    ...
                    <span>{`${<props></props>?.username ? "Đăng xuất" : "Đăng nhập"}`}</span>
                </div>
            </div>
        </nav>
    );
