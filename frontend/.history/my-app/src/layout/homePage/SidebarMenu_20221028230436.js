            ...
            <main>
                <div className="relative">
                    <div className="grid grid-cols-5 items-center content-end ">
                        ...
                        <div className="">
                            <img src="https://media.kenhtuyensinh.vn/images/article/01_01_2012/chong_choi_troi_ret_hoc_sinh_vung_kim_bon.jpg" alt="" className="h-[300px] w-[300px] object-cover" />
                        </div>
                        <div className="">
