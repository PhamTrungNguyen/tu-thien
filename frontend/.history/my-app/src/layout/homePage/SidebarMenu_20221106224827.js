    ...
    return (
        <nav>
            ...
            <div className="sidebar-footer">
                    ...
                    <div className="admin-profile hide">
                        ...
                        <div className="admin-info">
                            <h3 className="cursor-pointer">
                                <a href="#1">{` ${props.displayName ? props.displayName : props.username} `}</a>
                            </h3>
                            <h5>{`${props.role_name === 1 ? "user" : "admin"}`}</h5>
                        </div>
                    </div>
                ...
                <div className="tooltip">
                    <span className="show">{` ${props.displayName ? props.displayName : props.username} `} </span>
                    <span>Logout</span>
                </div>
            </div>
        </nav>
