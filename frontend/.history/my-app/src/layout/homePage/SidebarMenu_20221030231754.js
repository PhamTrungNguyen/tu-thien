    ...
    return (
        <nav>
            <div className="sidebar-top pb-[-50px] pb-[50px]">
                ...
                <h3 className="hide hide_title text-center">Quỹ từ thiện Tình Thương </h3>
            </div>
            ...
            <div className="sidebar-footer">
                ...
                <div className="admin-user tooltip-element" data-tooltip={1}>
                    <div className="admin-profile hide">
                        ...
                        <div className="admin-info">
                            <h3 className="cursor-pointer"><a href="#1">Trung Nguyên</a></h3>
                            <h5>Admin</h5>
                        </div>
                    </div>
                ...
                <div className="tooltip">
                    <span className="show">Trung Nguyên</span>
                    <span>Logout</span>
                </div>
            </div>
        </nav>
