            ...
            <main>
                <div className="relative">
                    <div className="grid grid-cols-5 items-center content-end ">
                        <div className="">
                            <img src={imageCenter1} alt="" className="max-h-[300px] max-w-[300px]" />
                        </div>
                        <div className="">
                            <img src={imageCenter2} alt="" className="max-h-[300px] max-w-[400px]" />
                        </div>
                        <div className="">
                            <img src={imageCenter1} alt="" className="max-h-[300px] max-w-[300px]" />
                        </div>
                        <div className="">
                            <img src={imageCenter1} alt="" className="max-h-[300px]" />
                        </div>
                        <div className="">
                            <img src={imageCenter1} alt="" className="max-h-[300px]" />
                        </div>
