        ...
        <div className="flex">
            ...
            <main>
                <div className="relative">
                    ...
                    <p className="text-center absolute top-[50%] left-[50%]">"Chúng tôi cùng với bạn, trên hành trình kiếm tìm hạnh phúc,bằng cách lan tỏa lòng nhân ái, chuyển hóa khổ đau." </p>
                </div>
            </main>
        </div>
