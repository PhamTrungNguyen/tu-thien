    ...
    return (
        <div className="flex">
            ...
            <main>
                <MainImage></MainImage>
                <div className="">
                    <div className="flex relative items-center h-[500px] ">
                        ...
                        <div className=" w-[50%] h-full p-[20px] bg-[#fbfbfc]">
                            <h3 className="font-semibold">KỲ 382: CHA BỆNH, CON THƠ, LO CHẠY ĂN TỪNG BỮA, GIA ĐÌNH NGHÈO LÂM CẢNH NỢ NẦN, TÚNG QUẪN</h3>
                            <p>Gia cảnh quá nghèo nên khi được bệnh viện báo bệnh không chữa được, người nhà không có điều kiện đưa chú Vũ nhập viện ở những bệnh viện lớn tại Sài Gòn đành đưa chú về nhà nằm chờ chết. Từ khi chú Vũ bị bệnh đến nay gia đình đã vay mượn hơn 70 triệu đồng. Những vật dụng có giá trị trong nhà đều đã bán hết mong có tiền chạy chữa cho cha nhưng đến nay bệnh tình ngày càng nặng không hề thuyên giảm. Căn nhà cũ kỹ bằng gỗ cũng bắt đầu mục nát. Hoàn cảnh hết sức khó khăn phải chạy ăn từng bữa.</p>
                        </div>
                    </div>
                </div>
            </main>
