    ...
    return (
        <nav>
                ...
                <ul>
                    ...
                    <li className="tooltip-element" data-tooltip={1}>
                        <NavLink
                            to={"/quan-ly"}
                            className={({ isActive }) => {
                                return isActive ? " w-full h-[53px] bg-[#3651d4] duration-300 rounded-[10px] " : "";
                            }}
            ...
            <div className="sidebar-footer">
                ...
                <div className="ml-[40px] mt-[20px] mb-[-20px] cursor-pointer" onClick={() => navigate("/update-user")}>Cập nhập tài khoản</div>
                <div className="tooltip">
                    {/*  
