...
const SidebarMenu = ({ styled, ...props }) => {
    console.log("🚀 ~ file: SidebarMenu.js ~ line 6 ~ SidebarMenu ~ styled", styled)
    ...
    return (
        <nav>
            ...
            <div className="sidebar-links mt-[30px]">
                <ul>
                    <div className="active-tab duration-300" style={{ top: `${styled}` }} />
                    <li className="tooltip-element" data-tooltip={0}>
                        <NavLink to={"/"} data-active={0} onClick={() => {
                            this.refresh();
                        }}>
                            <div className="icon">
