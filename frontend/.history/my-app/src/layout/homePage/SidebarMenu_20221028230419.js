            ...
            <main>
                <div className="relative">
                    <div className="grid grid-cols-5 items-center content-end ">
                        <div className="">
                            <img src={imageCenter1} alt="" className="h-[300px] w-[300px]" />
                        </div>
                        <div className="">
                            <img src={imageCenter2} alt="" className="h-[300px] w-[300px]" />
                        </div>
                        <div className="">
                            <img src="https://sohanews.sohacdn.com/k:thumb_w/640/2015/embevungcao-1451533696588/nhung-buc-anh-khien-ban-khong-the-song-ich-ky-duoc-nua.jpg" alt="" className="h-[300px] w-[300px] object-cover" />
                        </div>
                        <div className="">
                            <img src="http://hanoimoi.com.vn/Uploads/chiennv/2011/11/18/treemmnui.jpg" alt="" className="h-[300px] w-[300px] object-cover" />
                        </div>
                        <div className="">
                            <img src={imageCenter1} alt="" className="h-[300px] w-[300px]" />
                        </div>
