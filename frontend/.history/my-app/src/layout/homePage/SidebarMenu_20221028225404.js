        ...
        <div className="flex">
            ...
            <main>
                <div className="relative">
                    ...
                    <div>
                        <p className="text-center absolute text-image">"Chúng tôi cùng với bạn, trên hành trình kiếm tìm hạnh phúc," </p>
                        <p className="text-image">bằng cách lan tỏa lòng nhân ái, chuyển hóa khổ đau.</p>
                    </div>
