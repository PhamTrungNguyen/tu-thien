            ...
            <main>
                ...
                <div className="">
                    <div className="flex items-center justify-center h-[400px] ">
                        <div className="flex items-center justify-center flex-col w-[50%] h-full p-[20px] bg-[#f5f5f5]">
                            <div className="caption-box mb-[20px] absolute left-[10px]">
                                <p className="caption-text text-center text-[20px] font-bold">Dự Án Quan Trọng</p>
                            </div>
                            <div className="image-support">
                                <img src="https://nld.mediacdn.vn/2017/8-chan-1-1501857270466.jpg" alt="" />
                            </div>
                        </div>
                    ...
                    <div className="flex items-center justify-center h-[400px] mt-[50px]">
                        <div className="w-[50%] p-[20px] bg-[#f5f5f5]">
                        ...
                        <div className=" w-[50%] h-full p-[40px]  bg-[#fbfbfc]">
                            <h3 className="font-semibold">KỲ 382: CHA BỆNH, CON THƠ, LO CHẠY ĂN TỪNG BỮA, GIA ĐÌNH NGHÈO LÂM CẢNH NỢ NẦN, TÚNG QUẪN</h3>
                            <p>Gia cảnh quá nghèo nên khi được bệnh viện báo bệnh không chữa được, người nhà không có điều kiện đưa chú Vũ nhập viện ở những bệnh viện lớn tại Sài Gòn đành đưa chú về nhà nằm chờ chết. Từ khi chú Vũ bị bệnh đến nay gia đình đã vay mượn hơn 70 triệu đồng. Những vật dụng có giá trị trong nhà đều đã bán hết mong có tiền chạy chữa cho cha nhưng đến nay bệnh tình ngày càng nặng không hề thuyên giảm.</p>
                        </div>
                    </div>
                </div>
            </main>
