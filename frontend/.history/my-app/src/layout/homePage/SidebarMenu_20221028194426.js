...
import ManageSubMenus from "./ManageSubMenus";
import KeyboardArrowDownIcon from "@mui/icons-material/KeyboardArrowDown";
import { handleRenderHomeAdmin } from "../../common/js/main";
    ...
    return (
        <nav>
            <div className="sidebar-top">
                ...
                <h3 className="hide text-4xl">PI GROUP</h3>
            </div>
            ...
            <div className="sidebar-links">
              ...
              >
                Quản lý
                            ...
                            <span className="link hide" onClick={handleClick}>
                                Quản lý<KeyboardArrowDownIcon />
                            </span>
                            <ManageSubMenus
                                anchorEl={anchorEl}
                                open={open}
            ...
            <a href="#1" data-active={1}>
              ...
              <span className="link hide">Quản lý đề thi</span>
                ...
                <ul>
                    ...
                    <li className="tooltip-element" data-tooltip={2}>
                        <a href="#1" data-active={6}>
                            <div className="icon">
                                <i className="bx bx-cog" />
                                <i className="bx bxs-cog" />
                            </div>
                            <span className="link hide">Cài đặt</span>
                        </a>
                    </li>
                    <div className="tooltip">
