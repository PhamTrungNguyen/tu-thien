                    ...
                    <div className="flex h-[400px] ">
                        <div className="flex items-start justify-center flex-col w-[50%] h-full p-[30px] bg-[#f5f5f5]">
                            ...
                            <div className="image-support ">
                                <img src="https://nld.mediacdn.vn/2017/8-chan-1-1501857270466.jpg" alt="" className="h-[300px] w-[600px] object-cover" />
                            </div>
                        </div>
                        <div className="flex items-center justify-center flex-col w-[50%] h-full p-[40px] bg-[#fbfbfc]">
                            <a href="#" className="font-semibold cursor-pointer mb-[30px]">KỲ 382: CHA BỆNH, CON THƠ, LO CHẠY ĂN TỪNG BỮA, GIA ĐÌNH NGHÈO LÂM CẢNH NỢ NẦN, TÚNG QUẪN</a>
