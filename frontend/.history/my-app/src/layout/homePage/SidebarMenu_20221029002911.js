                ...
                <div className="">
                    <div className="flex h-[400px] ">
                        ...
                        <div className="flex items-center justify-center flex-col w-[50%] h-full p-[40px] bg-[#fbfbfc]">
                            <a href="#" className="font-semibold cursor-pointer">KỲ 382: CHA BỆNH, CON THƠ, LO CHẠY ĂN TỪNG BỮA, GIA ĐÌNH NGHÈO LÂM CẢNH NỢ NẦN, TÚNG QUẪN</a>
