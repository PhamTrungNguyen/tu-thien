        ...
        <div className="flex">
            ...
            <main>
                <div className="relative">
                    <div className="grid grid-cols-4 items-center content-end ">
                        <div className="">
                            <img src="https://quybongsen.org/wp-content/uploads/2018/06/bannerkid.jpg" alt="" className="max-h-[350px]" />
                        </div>
