        ...
        <div className="flex">
            ...
            <main>
                <div className="grid grid-cols-4 gap-x-[10px] items-center content-end ">
                    <div className="">
                        <img src="https://images.pexels.com/photos/1098795/pexels-photo-1098795.jpeg?cs=srgb&dl=pexels-namo-deet-1098795.jpg&fm=jpg&_gl=1*1r8vg0w*_ga*NDE0MjU5NTM0LjE2NjY5Njk4NjI.*_ga_8JE65Q40S6*MTY2Njk2OTg2NC4xLjEuMTY2Njk2OTg2Ni4wLjAuMA.." alt="" className="max-h-[350px]" />
                    </div>
                    <div className="">
                        <img src="https://images.pexels.com/photos/1098795/pexels-photo-1098795.jpeg?cs=srgb&dl=pexels-namo-deet-1098795.jpg&fm=jpg&_gl=1*1r8vg0w*_ga*NDE0MjU5NTM0LjE2NjY5Njk4NjI.*_ga_8JE65Q40S6*MTY2Njk2OTg2NC4xLjEuMTY2Njk2OTg2Ni4wLjAuMA.." alt="" className="max-h-[350px]" />
                    </div>
