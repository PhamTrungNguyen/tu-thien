                            ...
                            {imageList.map((image, index) => (
                                <div key={index} className="image-item">
                                    <img
                                        ...
                                        className="w-full"
                                    />
                                    <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center cursor-pointer absolute z-10 text-red-500 opacity-0 invisible transition-all group-hover:opacity-100 group-hover:visible">
                                        <svg
