...
const TextclamStyle = styled.div`
  flex: 1 1;
  margin-left: 10px;
      ...
      <main className="">
        ...
        <div className="flex px-[40px] pt-[40px]">
          ...
          <div className="w-[35%] flex flex-col justify-start pl-[20px]">
            <h3 className="text-[18px] font-bold pb-[30px]">
              Bài viết liên quan
            </h3>
            <div className="">
              <div className="flex flex-row items-start">
                ...
                <TextclamStyle>
                  <h3 className="text-[14px] font-semibold">
                    Khám bệnh từ thiện xã Ma Nới, huyện Ninh Sơn, tỉnh Ninh
                    Thuận
                  </h3>
                  <span className="">Th8 18, 2022</span>
                </TextclamStyle>
              </div>
            </div>
          </div>
