                    ...
                    <div className="grid grid-cols-4 gap-x-[20px]">
                        <div className="itemSupport-item border-2">
                            ...
                            <div className="p-[10px] flex flex-col items-center">
                                <h3 className="text-[17px] font-semibold text-[black]">Chung tay cùng bà con tuyến kênh Phèn, xã Vĩnh Viễn, Long Mỹ, Hậu Giang xây con đường mong ước của bao thế hệ</h3>
                            </div>
                        </div>
                    </div>
                </div>
