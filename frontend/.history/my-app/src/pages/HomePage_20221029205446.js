            ...
            <main>
                ...
                <div className="itemSupport p-[30px]">
                    <div className="grid grid-cols-4 gap-x-[20px]">
                        <div className="itemSupport-item border-2 flex flex-col items-center p-[10px]">
                        ...
                        <div className="itemSupport-item border-2 flex flex-col items-center">
                            ...
                            <div className="p-[10px] ">
                                <h3 className="text-[17px] font-semibold text-[black] mb-[20px]">Chung tay cùng bà con tuyến kênh Phèn,xã Vĩnh Viễn,</h3>

                            </div>
                            <p className="px-[10px] ">Cập nhật ngày 29/11/2018 Quỹ Từ thiện Bông Sen đã chuyển số tiền 22.450.000 đồng đến người dân tại tuyến Kênh Phèn. </p>
                            <div className="p-[10px] mt-auto ">
                                <ButtonDonate></ButtonDonate>
                            </div>
                        </div>
