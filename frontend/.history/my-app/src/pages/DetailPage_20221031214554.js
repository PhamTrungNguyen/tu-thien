...
const DetailPage = () => {
    ...
    console.log("🚀 ~ file: DetailPage.js ~ line 9 ~ DetailPage ~ imagePreview", imagePreview)
    const [imageData, setImageData] = useState(null);
    console.log("🚀 ~ file: DetailPage.js ~ line 11 ~ DetailPage ~ imageData", imageData)
    ...
    return (
        ...
        <div className="flex">
            ...
            <main className="">
                ...
                <div>
                    1231
                    <input accept="image/*" onChange={handleUploadClick} type="file" />
                </div>
                <button onClick={() => uploadImageWithAdditionalData()}>123213</button>
            </main>
        </div>
    );
};
