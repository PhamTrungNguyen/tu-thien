                    ...
                    <div className="grid grid-cols-4 gap-x-[20px]">
                        ...
                        <div className="itemSupport-item border-2">
                            ...
                            <div className="p-[10px] flex flex-col items-center">
                                ...
                                <p className="mt-auto mb-4">Cập nhật ngày 29/11/2018 Quỹ Từ thiện Bông Sen đã chuyển số tiền 22.450.000 đồng đến người dân tại tuyến Kênh Phèn. Con đường bê tông, niềm mong mỏi của bao thế hệ gần 50 năm nay đã thành hiện thực. Người dân và các em nhỏ không còn nỗi sợ bùn lầy, trơn</p>
                            </div>
                        </div>
                    </div>
                </div>
